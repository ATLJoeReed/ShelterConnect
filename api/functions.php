...
$results = pg_update($conn, "select * from ret_locations_tbl({$shelterName},{$bedsTotal},{$bedsAvailable},{$bedsInMaintenance},{$phone1},{$phone2},$phone{$phone3},{$address1},{$address2},{$city},{$state},{$zipCode},{$lat},{$long},{$id});");
