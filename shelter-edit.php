...
$results = pg_query($conn, "select name, beds_total, beds_available, beds_taken, beds_maintenance, phone_number_1, phone_number_2, phone_number_3, address1, address2, zip_code, lat, long from shelter join location on location.id=location_id;" );
